...
require 'google_ads_simple_api/concerns/has_extension_settings'
require 'google_ads_simple_api/base'
require 'google_ads_simple_api/ad_group'
require 'google_ads_simple_api/ad_group_criterion'
require 'google_ads_simple_api/budget'
require 'google_ads_simple_api/campaign'
require 'google_ads_simple_api/campaign_criterion'
require 'google_ads_simple_api/campaign_extension_setting'
require 'google_ads_simple_api/campaign_group'
require 'google_ads_simple_api/customer_extension_setting'
